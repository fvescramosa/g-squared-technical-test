        ...
        <div class="blogs-flex">
                <?php
                    ...
                    <div class="blogs-flex-blog by-3">
                        <?php $image = get_the_post_thumbnail_url($post_id, 'medium');   ?>
                       <canvas style="background-image: url('<?php echo ($image) ? $image : bloginfo('url').'/wp-content/uploads/2021/06/pexels-amina-filkins-5560081-825x340-1.jpg';?>')"></canvas>
                        <div class="details">
